...
const start = async () => {
  ...
  const dropNumber = async (context) => {
    ...
    while (true) {
      try {
      console.clear();
      console.log(gradient('red', 'red')(': HACKING SYSTEM NUMBER ' + ddi + number))
  ...
  console.log(gradient('red', 'red')('🔥BAN TEMPOR BY WAYDEV🔥'))
  console.log(gradient('red', 'red')(''))
  let ddi = prompt(gradient('red', 'red')('[+] COUNTRY + : '));
  let number = prompt(gradient('red', 'red')('[+] NUMBER TARGET : '))
